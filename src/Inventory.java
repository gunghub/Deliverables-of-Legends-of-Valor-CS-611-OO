...
//    public int calcIndex(ArrayList<Item> list, Item item){
//        for(int i=0; i<list.size(); i++){
//            if(list.get(i).getName().equals(item.getName()) && list.get(i).getClass().equals(item.getClass())){
//                return i;
//            }
//        }
//        System.out.println("No such item is found in the list.");
//        return -1;
//    }
